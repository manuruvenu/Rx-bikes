      ...
      >
        <div className="motor-type">
          ...
          <select value={motorName} onChange={handleMotorName} id="motor-name">
            <option value="TVS Raider">Rx 135(2001)</option>
            <option value="Royal Enfield Scram 411">Rx 100</option>
            <option value="Hero XPulse 200T 4V">Rx-z</option>
            <option value="BMW G 310 GS">Rx 100</option>
            <option value="Royal Enfield Himalayan">Rx 135(1995)</option>
            <option value="BMW R 1250 GS">Rx 135(1999)</option>
          </select>
        </div>
        ...
        <div className="pickup-place">
          ...
          <select value={pickPlace} onChange={handlePickPlace} id="pick-place">
            <option value="Downtown Toronto">btm</option>
            <option value="Niagara Falls">slikboard</option>
            <option value="Ottawa's Parliament Hill">whitefield</option>
            <option value="Banff National Park">majestic</option>
            <option value="Capilano Suspension Bridge">airport</option>
            <option value="Old Montreal Town">marathahalli</option>
          </select>
        </div>
        ...
        <div className="dropoff-place">
          ...
          <select value={dropPlace} onChange={handleDropPlace} id="drop-place">
            <option value="Old Montreal Town">btm</option>
            <option value="Ottawa's Parliament Hill">slikboard</option>
            <option value="Niagara Falls">whitefield</option>
            <option value="Banff National Park">majestic</option>
            <option value="Downtown Toronto">airport</option>

            <option value="Capilano Suspension Bridge">marathahalli</option>
          </select>
        </div>
